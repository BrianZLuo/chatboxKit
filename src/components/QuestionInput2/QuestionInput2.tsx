...
export const QuestionInput2 = ({ onSend, clearChat, disabled, placeholder, clearOnSend }: Props) => {
    ...
    return (
        <Stack horizontal className={styles.questionInputContainer}>
            <ClearChatButton className={styles.commandButton} onClick={myClearChat} disabled={!lastQuestionRef.current || isLoading} />
            <TextField
                id="voice-txt2"
